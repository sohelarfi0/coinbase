...
const Converter = ({symbol,icon,priceList}:ConverterProps) => {
    ...
    const conveertedPrice=(parseFloat(amount)||0)*(priceList[currency]||0);
  ...
  return (
    <div id='converter'>
        ...
        <div className='divider'>
            <div  className='line'/>
            <Image src="/converter.svg" alt="converter" 
            width={32} height={32} className='icon'/>

        </div>
        <div className='output-wrapper'>
            <p>{formatCurrency(conveertedPrice,2,currency,false)}</p>
